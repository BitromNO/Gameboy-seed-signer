...
After 99 rolls, press `Select` to open `SEED WORDS`. The 24 BIP39 English words are displayed six at a time. Use `Up` and `Down` to move between the four pages. Write the words down in order; do not photograph or send them electronically.
